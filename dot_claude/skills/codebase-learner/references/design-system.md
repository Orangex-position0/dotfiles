...
Complete CSS design tokens for the course. Copy this entire `:root` block into the course HTML and adapt the accent color to suit the project's personality. Designed for developer audiences — clean, readable, higher information density than typical marketing-style courses.
